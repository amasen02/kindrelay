...
type Props = { handover?: Handover; services: AppServices; pending: boolean; commit(operation: () => Promise<Handover>, success: string): Promise<boolean> };
...
export function TransferPanel({ handover, services, pending, commit }: Props) {
